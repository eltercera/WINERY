...
ALTER TABLE CATADOR_CONSULTOR ADD CONSTRAINT UQ_CC_ID;
...
ALTER TABLE CATA_EXPERTA ADD CONSTRAINT FK_Marca_Cata_Experta FOREIGN KEY FK_Marca REFERENCES MARCA (Mar_ID);
